// Enhanced Hill Navigation JavaScript with OpenStreetMap (FREE)
console.log('hill-navigation.js loaded successfully');
...
function initMap() {
    // Default center for Hill Campus (you should update this to your actual campus coordinates)
...
async function findPath() {
    ...
    try {
        const campus = 'hill'; // Since this is hill navigation
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing hill navigation with OpenStreetMap...');
    loadNodes('hill');
    initMap();
}); 