// Enhanced Deemed Navigation JavaScript with OpenStreetMap (FREE)
console.log('deemed-navigation.js loaded successfully');
...
function initMap() {
    // Default center for Deemed Campus (you should update this to your actual campus coordinates)
...
async function findPath() {
    ...
    try {
        const campus = 'deemed'; // Since this is deemed navigation
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing deemed navigation with OpenStreetMap...');
    loadNodes('deemed');
    initMap();
}); 